...
# install JHipster
su -c "yarn global add generator-jhipster@4.1.1" vagrant
...
apt-get install -y kubuntu-desktop virtualbox-guest-dkms virtualbox-guest-utils virtualbox-guest-x11
